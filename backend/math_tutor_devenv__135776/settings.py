"""
Django settings for math_tutor_devenv__135776 project.
...
ROOT_URLCONF = 'math_tutor_devenv__135776.urls'
...
WSGI_APPLICATION = 'math_tutor_devenv__135776.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "math_tutor_devenv__135776 API",
    "DESCRIPTION": "API documentation for math_tutor_devenv__135776 App",
    "VERSION": "v1",
}
